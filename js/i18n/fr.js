  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        faq6A: 'Vous ouvrez l’abonnement avec une carte, mais rien n’est débité pendant les {days} premiers jours. Le premier prélèvement se fait automatiquement à la fin de l’essai, puis chaque mois, jusqu’à résiliation. Résilier pendant l’essai ne coûte rien, et l’accès reste ouvert jusqu’à sa fin.',
        signIn: 'Connexion',
        ...
        heroNote: '{days} jours gratuits. Résiliez avant la fin de l’essai et vous n’êtes pas débité du tout.',
        ...
        pricingNote: 'Tarifs en ILS, par mois, hors TVA. {days} jours gratuits sur toutes les formules : le premier prélèvement n’arrive qu’à la fin de l’essai, et résilier avant ne coûte rien.',
