...
(function (root) {
  ...
  root.I18n.register({
    ...
    dict: {
      ...
      positions: {
        title: 'الأدوار',
        hint: 'صرّاف، مرتِّب، مطبخ، نادل — ما يحتاجه نشاطكم. يمكن للموظف أن يحمل عدة أدوار، وللوردية أن تطلب دورًا واحدًا.',
        add: 'إضافة دور',
        newName: 'دور جديد',
        name: 'اسم الدور',
        remove: 'حذف الدور',
        ...
        slotLabel: 'الدور المطلوب',
        slotAny: 'أي أحد',
        slotHint: 'هذه الوردية ستبحث فقط عمّن يحمل هذا الدور.',
        count: '{count} أدوار',
        fits: '{count} مناسبون'
      },
      ...
      importData: {
        ...
        hint: 'حدّد قائمتك في إكسل، وانسخها والصقها هنا — أو اختر ملف CSV. العمود الأول هو الاسم. بعده، إن كانت لديك: الفروع وأنواع المناوبات وحصة أسبوعية. الفرع غير الموجود سيُنشأ تلقائيًا. يمكن إضافة عمود بريد – فهو يمنع إنشاء بطاقة ثانية للشخص نفسه.',
