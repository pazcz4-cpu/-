  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroNote: '{days} días gratis, sin tarjeta. Solo hace falta un método de pago para seguir después de la prueba.',
        heroNoteCard: '{days} días sin cargo. Introduces una tarjeta al registrarte y el primer cobro llega solo al terminar la prueba: si cancelas antes, no pagas nada.',
        pricingNoteCard: 'Precios en ILS, al mes, IVA del 18% incluido. Introduces una tarjeta al registrarte y no se cobra nada durante {days} días; después se renueva cada mes hasta que canceles.',
