  ...
  root.I18n.register({
    ...
    dict: {
      app: {
        ...
        subtitle: 'Planificación semanal para cada sucursal, con detección de solapamientos y huecos',
        language: 'Idioma'
      },
      ...
      auth: {
        ...
        trialNote: '{days} días gratis. No hace falta método de pago.',
      ...
      access: {
        ...
        trialEnded: 'La prueba ha terminado. Activa una suscripción para continuar.',
        trial: 'Prueba: quedan {days} días.',
