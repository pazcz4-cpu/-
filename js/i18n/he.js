...
(function (root) {
  ...
  root.I18n.register({
    ...
    dict: {
      ...
      positions: {
        title: 'תפקידים',
        hint: 'קופאי, סדרן, מטבח, מלצר — מה שהעסק שלכם צריך. עובד יכול להחזיק כמה תפקידים, ומשמרת יכולה לחפש תפקיד אחד.',
        add: 'הוספת תפקיד',
        newName: 'תפקיד חדש',
        name: 'שם התפקיד',
        remove: 'מחיקת תפקיד',
        ...
        slotLabel: 'תפקיד נדרש',
        slotAny: 'כל אחד',
        slotHint: 'המשמרת הזו תחפש רק עובדים שמסומנים בתפקיד הזה.',
        count: '{count} תפקידים',
        fits: '{count} מתאימים'
      },
