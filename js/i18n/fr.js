  ...
  root.I18n.register({
    ...
    dict: {
      ...
      auth: {
        ...
        trialNote: '{days} jours gratuits. Aucun moyen de paiement requis.',
      ...
      access: {
        ...
        trialEnded: 'La période d’essai est terminée. Activez un abonnement pour continuer.',
        trial: 'Essai – {days} jours restants.',
