...
/* תג הפתיחה הוא המשפט הראשון שנקרא בדף, ולכן הוא זה שמחליט אם
   הקורא ממשיך. הנוסח הקודם — "לרשתות רב-סניפיות" — אמר לבעל
   עסק אחד עם שמונה עובדים שהמוצר אינו בשבילו, והוא כן. המוצר
   עובד משני הקצוות, ולכן התג חייב לנקוב בקצה הקטן במפורש
   ולא רק לרמוז שהוא גם אפשרי. */
test('תג הפתיחה מדבר גם אל עסק עם סניף אחד', function () {
  var single = {
    he: 'מסניף אחד', en: 'one location', ar: 'فرع واحد',
    de: 'einzelnen Standort', es: 'una sola sucursal',
    fr: 'un seul site', pt: 'de uma loja', ru: 'одной точки'
  };
  I18n.list().forEach(function (lang) {
    I18n.use(lang.code);
    var badge = I18n.t('landing.heroBadge');
    var needle = single[lang.code];
    assert(needle, lang.code + ': לא הוגדר מה מסמן סניף אחד בשפה הזו');
    assert(badge.indexOf(needle) !== -1,
      lang.code + ': תג הפתיחה אינו מזכיר עסק עם סניף אחד — "' + badge + '"');
  });
  I18n.use('he');
});
