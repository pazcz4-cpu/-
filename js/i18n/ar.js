  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        faq6A: 'تفتح الاشتراك ببطاقة، لكن لا يُخصم شيء خلال الأيام {days} الأولى. يتم أول خصم تلقائيًا عند انتهاء فترة التجربة، ثم شهريًا حتى تلغي. الإلغاء أثناء التجربة لا يكلّف شيئًا، ويبقى الوصول حتى نهايتها.',
        signIn: 'تسجيل الدخول',
        start: 'ابدأ مجانًا',
        ...
        heroSubtitle: 'يبني الذكاء الاصطناعي في SetShifts جدول كل فرع بنفسه — حسب توفر الموظفين، والطلبات التي يقدّمونها، وحدود الساعات، والأدوار، وقواعد عملك. ولكل إسناد يخبرك لماذا هذا الشخص تحديدًا. أنت تعتمد، لا تبني.',
        heroNote: '{days} يومًا مجانًا. ألغِ قبل انتهاء التجربة ولن يُخصم منك شيء إطلاقًا.',
        ...
        pricingNote: 'الأسعار بالشيكل، شهريًا، غير شاملة الضريبة. {days} يومًا مجانًا في كل باقة — لا يأتي أول خصم إلا بعد انتهاء التجربة، والإلغاء قبلها لا يكلّف شيئًا.',
      ...
      preview: {
        ...
        hint: 'للعرض فقط. لا يُحفظ أي شيء هنا باسم الموظف.',
