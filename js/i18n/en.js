  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroNoteCard: '{days} days free. You enter a card at signup and the first charge comes only when the trial ends — cancel before that and you pay nothing.',
        pricingNoteCard: 'All prices in ILS, per month, including 18% VAT. You enter a card at signup and are not charged for {days} days; after that it renews monthly until you cancel.',
