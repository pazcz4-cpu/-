  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        faq6A: 'Abres la suscripción con una tarjeta, pero no se cobra nada durante los primeros {days} días. El primer cobro se hace automáticamente al terminar la prueba, y después cada mes, hasta que canceles. Cancelar durante la prueba no cuesta nada, y el acceso sigue hasta que termina.',
        signIn: 'Entrar',
        ...
        heroSubtitle: 'La IA de SetShifts crea sola el cuadrante de cada sucursal: según la disponibilidad del equipo, las solicitudes que envían, los límites de horas, los puestos y tus propias reglas. Y de cada asignación te dice por qué esa persona. Tú apruebas; no construyes.',
        heroNote: '{days} días gratis. Cancela antes de que termine la prueba y no se te cobra nada.',
        ...
        pricingNote: 'Precios en ILS, al mes, IVA no incluido. {days} días gratis en todos los planes: el primer cobro llega solo al terminar la prueba, y cancelar antes no cuesta nada.',
