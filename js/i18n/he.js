  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroSubtitle: 'ה-AI של SetShifts בונה לבד את הסידור לכל הסניפים — לפי זמינות העובדים, האילוצים שהגישו, מכסות השעות, התפקידים וכללי העסק שלכם. ועל כל שיבוץ הוא מסביר למה דווקא האדם הזה. אתם מאשרים, לא בונים.',
