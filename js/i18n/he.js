  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        faq6A: 'פותחים מנוי עם כרטיס אשראי, אבל ב-{days} הימים הראשונים אין חיוב בכלל. החיוב הראשון מתבצע אוטומטית בתום התקופה, ומשם כל חודש — עד שמבטלים. ביטול בתוך תקופת הניסיון אינו עולה דבר, והגישה נשמרת עד סוף התקופה.',
        ...
        heroNote: '{days} ימי ניסיון ללא חיוב. ביטול בכל רגע לפני תום התקופה — ולא תחויבו בכלל.',
        ...
        pricingNote: 'כל המחירים בשקלים, לחודש, לא כולל מע״מ. {days} ימי ניסיון ללא חיוב בכל תוכנית — החיוב הראשון רק בתום התקופה, וביטול לפני כן לא יחויב.',
      ...
      auth: {
        ...
        trialNote: '{days} ימים ללא חיוב. החיוב הראשון ב-{date}, וביטול לפני כן לא יחויב כלל.',
