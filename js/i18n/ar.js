  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroNoteCard: '{days} يومًا بدون رسوم. تُدخل البطاقة عند التسجيل، وأول خصم يكون فقط عند انتهاء التجربة — ومن يلغي قبل ذلك لا يُخصم منه شيء.',
        pricingNoteCard: 'الأسعار بالشيكل، شهريًا، شاملة ضريبة القيمة المضافة 18%. تُدخل البطاقة عند التسجيل ولا يتم خصم أي مبلغ لمدة {days} يومًا؛ بعدها يتجدد الاشتراك شهريًا حتى الإلغاء.',
        ...
        pricingNote: 'الأسعار بالشيكل، شهريًا، شاملة ضريبة القيمة المضافة 18%. {days} يومًا مجانًا في كل باقة وبدون بطاقة — تضيف وسيلة دفع فقط للاستمرار بعد انتهاء التجربة.',
