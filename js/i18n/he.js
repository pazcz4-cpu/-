...
(function (root) {
  ...
  root.I18n.register({
    ...
    dict: {
      app: {
        title: 'SetShifts',
        subtitle: 'שיבוץ אוטומטי לכל הסניפים — לפי זמינות, אילוצים, תפקידים וכללי העסק',
        language: 'שפה'
      },
      ...
      landing: {
        ...
        heroBadge: 'שיבוץ אוטומטי לרשתות עם יותר מסניף אחד',
        heroTitle: 'סידור העבודה של כל העסק. בלחיצה אחת.',
        heroSubtitle: 'SetShifts בונה לבד את הסידור לכל הסניפים — לפי זמינות העובדים, האילוצים שהגישו, מכסות השעות, התפקידים וכללי העסק שלכם. אתם מאשרים, לא בונים.',
