  ...
  root.I18n.register({
    ...
    dict: {
      ...
      importData: {
        ...
        hint: 'حدّد قائمتك في إكسل، وانسخها والصقها هنا — أو اختر ملف CSV. العمود الأول هو الاسم. بعده، إن كانت لديك: الفروع وأنواع المناوبات وحصة أسبوعية. الفرع غير الموجود سيُنشأ تلقائيًا.',
