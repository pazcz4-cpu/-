  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroNote: '{days} dias grátis — sem cartão. Só precisas de um método de pagamento para continuar depois da experiência.',
        heroNoteCard: '{days} dias sem cobrança. Introduzes um cartão no registo e a primeira cobrança só acontece no fim do período — se cancelares antes, não pagas nada.',
        pricingNoteCard: 'Preços em ILS, por mês, IVA de 18% incluído. Introduzes um cartão no registo e não há cobrança durante {days} dias; depois renova mensalmente até cancelares.',
