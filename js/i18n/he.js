  ...
  root.I18n.register({
    ...
    dict: {
      ...
      landing: {
        ...
        heroNoteCard: '{days} ימים ללא חיוב. מזינים כרטיס בהרשמה, והחיוב הראשון רק בתום התקופה — מי שמבטל לפני כן לא מחויב כלל.',
        pricingNoteCard: 'כל המחירים בשקלים, לחודש, כוללים מע״מ 18%. מזינים כרטיס בהרשמה ולא מחויבים במשך {days} ימים; אחר כך החיוב חודשי עד לביטול.',
        ...
        pricingNote: 'כל המחירים בשקלים, לחודש, כוללים מע״מ 18%. {days} ימי ניסיון בכל תוכנית, בלי כרטיס אשראי — אמצעי תשלום מוסיפים רק כדי להמשיך אחרי תום התקופה.',
