...
/* התוכנית הפעילה בפועל. אחרי שהמעבר ל-Pro יושלם — משנים כאן
   ל-'pro', במקום אחד, וההתראה מפסיקה להיות רלוונטית. */
var PLAN = 'hobby';
/* Hobby מגבילה ל-12 פונקציות בפריסה. ב-Pro אין את המגבלה הזו,
   ולכן הערך שם הוא רק תקרה שפויה נגד ריבוי נקודות קצה. */
var MAX_FUNCTIONS = PLAN === 'pro' ? 40 : 12;
/* מאיזה מספר כדאי כבר לדעת. אחת לפני התקרה, כי שעון הנוכחות
   הביא אותנו מדעת ל-10 מתוך 12: זו הייתה החלטה ולא הפתעה,
   והמספר שמזהיר צריך להזהיר על מה שלא תוכנן. */
var WARN_AT = PLAN === 'pro' ? MAX_FUNCTIONS - 2 : 11;
